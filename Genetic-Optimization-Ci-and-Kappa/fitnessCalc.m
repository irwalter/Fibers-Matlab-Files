function [ preFitness, preFitAve, rawFitness, avgFitness, popOut ] = ...
    fitnessCalc( pop, pMin, pMax, data, myFunct, a2,omega,gamma_dot,totalStrain,closureType,delta_time,a_ij_calc_index, a_ij_mech)
% pop represents the individuals whose fitness is to be assessed
...
for i = 1:h
    ...
    % y = feval(myFunct,p,a2,omega,gamma_dot,totalStrain,closureType,delta_time,a_ij_calc_index, a_ij_mech,x');
    y = ComputeRSC_Evolution( a2, omega, gamma_dot, totalStrain, p(1), p(2), closureType,delta_time, a_ij_calc_index, a_ij_mech, x );
    %y = p(1)*x+p(2);
